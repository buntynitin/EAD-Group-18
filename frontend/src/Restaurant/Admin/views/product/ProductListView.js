...
function ProductListView() {
  ...
  const handelAddItem = (e) => {
    ...
    axios.post('http://192.168.29.82:3001/api/restaurant/addFood', formdata, {
      headers: {
  ...
  useEffect(() => {
    ...
    // ).then(function (response) {
      ...
      axios.get(`http://192.168.29.82:3001/api/restaurant/restaurantCatalog?owner_id=${state._id}`
