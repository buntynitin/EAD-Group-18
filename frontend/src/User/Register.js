...
const useStyles = makeStyles((theme) => ({
    ...
    message: {
      ...
      error: {
        backgroundColor: (theme.palette.type === 'dark')?theme.palette.error.light:theme.palette.error.dark
      },
      icon: {
...
function Register(props) {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://192.168.29.82:3001/api/user/register', {
        name,email,password
      ...
      >
        ...
        />
          ...
          <div className={classes.register}>
                <Link to={"/user/login"} style={{color:props.isDark?"#9FA8DA":"rgb(63,81,181)",textDecoration:"none"}}>
