  ...
  return (
    <div>
       <Dialog
        ...
        style={{background:(theme.palette.type === 'dark')?"rgba(255,255,255,0.6)":"rgba(0,0,0,0.6)"}}
        fullWidth={true}
        maxWidth={'sm'}
        open={open}
        onClose={handleClose}
      ...
      >
          ...
          <Map handleClose={handleClose} update={update} setUpdate={setUpdate} />
...
<Grid container spacing={0}>
                                    <Grid item xs={2} sm={1}>
                                        <div style={{width:"100%", background:(theme.palette.type === 'dark')?"#9FA8DA":"rgb(63,81,181)", height:"100%", display:"flex",alignItems:"center"}}>
                                            
                                               
                                            <MapPin style={{marginLeft:"50%", transform:"translatex(-50%)",color:(theme.palette.type === 'dark')?"#000000":"#ffffff"}}  />
