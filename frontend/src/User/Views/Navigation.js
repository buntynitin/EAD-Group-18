        ...
        <Source type="geojson" data={geojson}>
         ...
         latitude={socketResponse.latitude}>
           ...
           {socketResponse.heading?
            <NavigationIcon style={{ transform:`translate(-12px,-22px) rotate(${Math.trunc(socketResponse.heading)}deg)` ,color:"#f26419"}} />:
         ...
         <div style={{position:"absolute",padding:"4px",margin:"8px" ,background:(theme.palette.type === 'dark')?"rgba(0,0,0,0.5)":"rgba(255,255,255,0.8)", borderRadius:"4px"}}>
           <center>
...
<div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
          <Avatar style={{ margin: "0px 8px 8px 8px",marginTop:"8px", width: "42px", height: "42px", backgroundColor:(theme.palette.type === 'dark')?"rgba(0,0,0,0.5)":"rgba(255,255,255,0.9)" }}>
            <IconButton onClick={()=> handleRecenter()}>
              <SettingsBackupRestoreIcon style={{ color:(theme.palette.type === 'dark')?"#fff":"#000" }} />
            </IconButton>
          </Avatar>
    </div>
    </ReactMapGL>
