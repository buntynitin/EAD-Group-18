...
function Login(props) {
  ...
  const responseSuccessGoogle = (response) => {
    setLoginError('');
    axios.post('http://192.168.29.82:3001/api/user/glogin',
  ...
  const responseFacebook = (response) => {
    ...
    setLoginError('');
    axios.post('http://192.168.29.82:3001/api/user/flogin',
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://192.168.29.82:3001/api/user/login',
      formJson
    ).then(function (response) {
      const storedJwt = localStorage.getItem('user_token');
  ...
  return (
    <div>
      ...
      <Grid container className={classes.root}>
        ...
        <Grid item className={classes.header} xs={12} md={4} style={{ borderRadius: "0px 0px 30px 30px",background: props.isDark ?"#333533":"#edf2f4" }}>
          <center>
        ...
        <Grid item xs={12} md={8}>
          <div className={classes.formdiv}>
            ...
            <form className={classes.form} autoComplete="off" onSubmit={handleSubmit}>
              ...
              <FormControlLabel
                control={<Checkbox checked={remember} color="primary" onChange={(e) => setRemember(e.target.checked)} style={{color: props.isDark?"#9FA8DA":"rgb(63,81,181)"}} />}
                label="Remember me"
              />
              ...
              <Button
                ...
                style={{background:isSubmitting?'#E0E0E0':props.isDark?"#9FA8DA":"rgb(63,81,181)",color:isSubmitting?'#9E9E9E':props.isDark?"#000000":"#ffffff"}}
                  ...
                  <GoogleLogin
                    ...
                    render={renderProps => (
                      ...
                      <Button
                        ...
                        size="large"
                        variant="contained"
                        style={{ marginTop: "16px", textTransform: 'none', color: props.isDark?"#ffffff":"gray", background: props.isDark?"#616161":"rgb(255,255,255)" }}
                  ...
                  <FacebookLogin
                    ...
                    render={renderProps => (
                      ...
                      <Button
                        ...
                        style={{ marginTop: "16px", textTransform: 'none', color:"white", background: props.isDark?"#616161":"rgb(67,96,156)" }}
                        // className={classes.submit}
                        disabled={renderProps.disabled}
                      >
    ...
    Facebook
              ...
              <div className={classes.register}>
                <Link to="/user/register" style={{color:props.isDark?"#9FA8DA":"rgb(63,81,181)",textDecoration:"none"}}>
                  <Typography variant="body1">Don't have an account? Sign Up</Typography>
                </Link>
              </div>

              {loginError && (
                <Alert style={{ marginTop: "16px",backgroundColor:"#fdecea",color:props.isDark?'#000':'#000' }} severity="error">{loginError}</Alert>
              )}
            </form>
